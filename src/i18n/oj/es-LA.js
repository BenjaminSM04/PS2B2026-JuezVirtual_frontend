export const m = {
  ...
  Page_Not_Found_Title: 'La página no existe',
  Page_Not_Found_Hint: 'Algo salió mal o la URL es incorrecta',
  // Problem.vue
  ...
  Contests: 'Concursos',
  NavStatus: 'Estado',
  Submission_Status: 'Estado de Envíos',
  Rank: 'Ranking',
  ...
  Welcome_back: 'Bienvenido de vuelta a LizardJudge Univalle',
  University_Subtitle: 'Universidad Privada del Valle · Sede La Paz',
  ...
  TimeList: 'Tiempo',
  Problem: 'Problema',
  Problem_Submissions: 'Envíos del Problema',
  ID: 'ID',
  Time: 'Tiempo',
  Memory: 'Memoria',
  Author: 'Autor',
  ...
  // Contest overview enriquecido
  Total_Problems: 'Problemas',
  Total_Participants: 'Participantes',
  Total_Submissions: 'Envíos',
  Total_AC: 'Aceptados',
  Top_Ranking: 'Top del Ranking',
  View_Full_Ranking: 'Ver ranking completo',
  Recent_Announcements: 'Anuncios recientes',
  View_All_Announcements: 'Ver todos los anuncios',
  No_Ranking_Yet: 'Aún no hay participantes en el ranking.',
  Rank_Position: 'Pos',
  // Crear anuncio desde el concurso
  Create_Contest_Announcement: 'Crear Anuncio',
  Announcement_Created: 'Anuncio publicado correctamente',
  // Timer del concurso
  Starts_In: 'Empieza en',
  Ends_In: 'Termina en',
  Contest_Finished: 'Finalizado',
  Contest_Password_Placeholder: 'Contraseña del concurso',
  Enter: 'Entrar',
  // Profile setting
  Avatar_Setting: 'Configuración de Avatar',
  Profile_Setting: 'Configuración del Perfil',
  Drag_Or_Click_To_Upload: 'Arrastra una imagen aquí o haz clic para seleccionar',
  Upload_Avatar: 'Subir avatar',
  Avatar_Will_Update_To: 'Tu avatar se actualizará a:',
  ...
  Blog: 'Blog',
  Github: 'Github',
  Discard_Changes_Confirm: '¿Desea descartar los cambios realizados?',
  Avatar_Updated: 'Avatar actualizado correctamente',
  Avatar_Upload_Failed: 'Ocurrió un error al subir la imagen',
  Fill_Fields_Correctly: 'Complete correctamente los campos',
  Profile_Updated: 'Perfil actualizado correctamente',
  Profile_Update_Failed: 'Ocurrió un error al guardar los cambios',
  // Security setting
  ...
  TFA_Enabled_Notice: 'Has activado la autenticación de dos factores.',
  Enter_TFA_Code: 'Ingresa el código de tu app autenticadora',
  Open_TFA: 'Activar 2FA',
  Close_TFA: 'Desactivar 2FA',
  Revoke_Session_Confirm: '¿Seguro que quieres revocar la sesión?',
  Close_TFA_Confirm: 'La autenticación de dos factores protege tu cuenta. ¿Seguro que quieres desactivarla?'
}
